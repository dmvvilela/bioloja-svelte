...
<div class="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow mt-3">
	...
	<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
		<p class="text-accent">
			Caso queira alterar sua senha, clique em Sair para deslogar da sua conta, em seguida clique no
			link "esqueci a senha" na tela de login e siga as instruções indicadas.
		</p>
	</div>
