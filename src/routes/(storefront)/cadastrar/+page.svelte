...
<svelte:head>
	<title>Cadastrar - Bioloja</title>
	<meta name="description" content="Crie sua conta na Bioloja." />
</svelte:head>
...
<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
	...
	<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
		<div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
			<h2 class="text-2xl uppercase font-medium mb-1">Cadastrar</h2>
			<p class="text-gray-600 mb-6 text-sm">Seja Bem-vindo(a)</p>
			<form class="space-y-6" method="POST" use:enhance>
				<div>
					<label for="name" class="block text-sm font-medium leading-6 text-secondary"
						>Nome completo</label
					>
					<div class="mt-2">
						<input
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						...
						/>
						<label for="aggrement" class="ml-3 block text-sm leading-6 text-secondary"
							>Eu li e concordo com os <a href="/termos-e-condicoes" class="text-primary"
			...
			<!-- <div>
				<div class="relative mt-10">
					...
					<div class="relative flex justify-center text-sm font-medium leading-6">
						<span class="bg-white px-6 text-secondary">Or continue with</span>
					</div>
				</div>
				...
				<div class="mt-6 grid grid-cols-2 gap-4">
					<a
						href="#"
						class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-secondary shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
					>
