									...
									<span class="flex flex-1">
										<span class="flex flex-col">
											...
											<span
												...
												class="mt-6 text-sm font-medium text-gray-900">R$5.00</span
											>
										</span>
									</span>
									<!-- Not Checked: "hidden" -->
									...
									<span class="flex flex-1">
										<span class="flex flex-col">
											...
											<span
												...
												class="mt-1 flex items-center text-sm text-gray-500">2–5 business days</span
											>
											<span
												id="delivery-method-1-description-1"
												class="mt-6 text-sm font-medium text-gray-900">R$16.00</span
											>
										</span>
									</span>
									<!-- Not Checked: "hidden" -->
					...
					<div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
						...
						<dl class="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
							...
							<div class="flex items-center justify-between">
								...
								<dd class="text-sm font-medium text-gray-900">R$5.00</dd>
							</div>
							<div class="flex items-center justify-between">
								<dt class="text-sm">Taxes</dt>
								<dd class="text-sm font-medium text-gray-900">R$5.52</dd>
							</div>
