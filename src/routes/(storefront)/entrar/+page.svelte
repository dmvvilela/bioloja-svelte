...
<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
	...
	<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
		<div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
			...
			<p class="text-gray-600 mb-6 text-sm">Bem-vindo(a) de volta</p>
			<form class="space-y-6" method="POST" use:enhance>
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						...
						/>
						<label for="remember-me" class="ml-3 block text-sm leading-6 text-secondary"
							>Lembrar-me</label
						>
					</div>

					<div class="text-sm leading-6">
						<a href="/esqueci-a-senha" class="font-medium text-primary hover:text-secondary"
		...
		<p class="mt-10 text-center text-sm text-gray-500">
			...
			<a href="/cadastrar" class="font-semibold leading-6 text-primary hover:text-secondary"
				>Cadastre-se</a
			>.
		</p>
	</div>
